        ...
        {leetcode ? (
          ...
          <form onSubmit={handleLinkLeetCode} className="flex gap-2">
            <input
              ...
              required
              className="flex-1 px-3 py-2 border border-gray-200 rounded-lg text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500"
            />
            <button
              type="submit"
